/*
    ...
    Filename:      S55NLLGSPH_X512Y16D32_BW.v
    IP code :      S55NLLGSPH
    Version:       1.1.a
...
module S55NLLGSPH_X512Y16D32_BW(
                          Q,
			  CLK,
			  CEN,
			  WEN,
 ...
 BWEN_flag = {
  ...
  specify
    ...
    $period(posedge CLK,2.715,CLK_CYC_flag);
    $width(posedge CLK,0.815,0,CLK_H_flag);
    $width(negedge CLK,0.815,0,CLK_L_flag);
